        ...
        <html lang="fr">
            ...
            <body class="light">
                <div id="layout">
                    ...
                    <div class="col c12">
                        <h2><img src="images/heartbeat.png" height="50" width="50"></img><xsl:value-of select="exo/title"/></h2>
                        <p><xsl:value-of select="exo/phase1/description"/></p>
                        <a href="exos/Exo6/6_0.xml"><xsl:value-of select="exo/phase1/fichierXml"/></a><br></br>
                        <a href="exos/Exo6/6.xsl"><xsl:value-of select="exo/phase1/fichierXsl"/></a><br></br>
                        <a href="exos/Exo6/6.xml"><xsl:value-of select="exo/phase1/lien"/></a><br></br>
