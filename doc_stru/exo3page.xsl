        ...
        <html lang="fr">
            ...
            <body class="light">
                <div id="layout">
                    ...
                    <div class="col c12">
                        <h2><img src="images/list.png" height="50" width="50"></img><xsl:value-of select="exo/title"/></h2>
                        <p><xsl:value-of select="exo/description/p"/></p>
                        <b><h><xsl:value-of select="exo/description/type1/name"/></h></b>
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/description/type1/exemple"/></code></pre><br></br>
                        <b><h><xsl:value-of select="exo/description/type2/name"/></h></b>
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/description/type2/exemple"/></code></pre>
                        <br></br>
                        <br></br>
                        <hr style="border:1.5px dashed  #e6b0aa; height:1px"></hr>
                        <br></br>
                    </div>
                    <div class="col c12">
                        
                        <p>En ce qui concerne les exercices:</p>
                        <b><h><xsl:value-of select="exo/phase1/title"/></h></b>
                        <p><xsl:value-of select="exo/phase1/txt"/></p>
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/phase1/affiche"/></code></pre><br></br>
                        <b><h><xsl:value-of select="exo/phase2/title"/></h></b>
                        <p><xsl:value-of select="exo/phase2/txt"/></p>  
                        <a href="exos/Exo3/bibliographie.xml"><xsl:value-of select="exo/phase2/fichier"/></a>
                        <br></br>
