        ...
        <html lang="fr">
            ...
            <body class="light">
                <div id="layout">
                    ...
                    <div class="col c4">
                        <img src="images/profil_1.png" height="100" width="100"></img>
                        <h3><xsl:value-of select="contacts/profil1/nom"/></h3>
                        <a href="Mailto:yang.mengwei@icloud.com"><xsl:value-of select="contacts/profil1/mail"/></a>
                        <a href="http://www.univ-paris3.fr/"><h4><xsl:value-of select="contacts/profil1/ecol"/></h4></a>
                    </div>
                        <div class="col c4">
                            <img src="images/profil_2.png" height="100" width="100"></img>
                            <h3><xsl:value-of select="contacts/profil2/nom"/></h3>
                            <a href="Mailto:shinmanoko@gmail.com"><xsl:value-of select="contacts/profil2/mail"/></a>
                            <a href="https://university.u-paris10.fr//"><h4><xsl:value-of select="contacts/profil2/ecol"/></h4></a>
                        </div>
                        <div class="col c3">
                        </div>
                    </div>
