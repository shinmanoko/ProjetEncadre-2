        ...
        <html lang="fr">
            ...
            <body class="light">
                <div id="layout">
                    ...
                    <div class="row">
                        <div class="col c12 aligncenter navmenu">
                            <p>
                                ...
                                <a href="exo9page.xml" class="exercice" >10</a>
                    ...
                    <div class="col c12">
                        <h2><img src="images/milk-shake.png" height="50" width="50"></img><xsl:value-of select="exo/Title"/></h2>

                        <xsl:for-each select="exo/description/p">
                        
                            <p><xsl:value-of select="."/></p>
                        </xsl:for-each>
                        <a href="exos/Exo1/exercice1xml.xml"><xsl:value-of select="exo/description/a1"/></a><br></br>
                        <a href="exos/Exo1/exercice1.xsl"><xsl:value-of select="exo/description/a2"/></a><br></br>
                        <a href="exos/Exo1/exercice1.xml"><xsl:value-of select="exo/description/a3"/></a><br></br>
