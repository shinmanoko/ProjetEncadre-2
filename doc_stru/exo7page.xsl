        ...
        <html lang="fr">
            ...
            <body class="light">
                <div id="layout">
                    ...
                    <div class="col c12">
                        <h2><img src="images/魔法水.png" height="55" width="55"></img><xsl:value-of select="exo/title"/></h2>
                    </div>
                    <div class="col c12">
                        <h><b><xsl:value-of select="exo/phase1/title"/></b></h>
                        <p><xsl:value-of select="exo/phase1/description"/></p>
                        <a href="exos/Exo7/rec_xslt.tag0.xml"><xsl:value-of select="exo/phase1/fichier"/></a>
                        <p><xsl:value-of select="exo/phase1/fichierDTD"/></p>
                    ...
                    <div class="col c12">
                        ...
                        <p><xsl:value-of select="exo/phase2/question1/description"/></p>                                            
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/phase2/question1/xpath"/></code></pre><br></br>
                        <p><xsl:value-of select="exo/phase2/question2/description"/></p>                                            
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/phase2/question2/xpath"/></code></pre><br></br>
                        <p><xsl:value-of select="exo/phase2/question3/description"/></p>                                            
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/phase2/question3/xpath"/></code></pre><br></br>
                        <br></br>
                        <hr style="border:1px dashed  #e6b0aa; height:1px"></hr>
                        <br></br>
                    </div>
                    <div class="col c12">
                        ...
                        <a href="exos/Exo7/exo7_3.1.xsl"><xsl:value-of select="exo/phase3/etape1/fichierXsl"/></a><br/>
                        <a href="exos/Exo7/rec_xslt.tag.xml"><xsl:value-of select="exo/phase3/etape1/resultat"/></a><br/><br/>
                        <p><xsl:value-of select="exo/phase3/etape2/description"/></p>
                        <pre class="prettyprint"><code class="language-xml"><xsl:value-of select="exo/phase3/etape2/commande"/></code></pre><br/>
                        <a href="exos/Exo7/exs3_2.xsl"><xsl:value-of select="exo/phase3/etape2/fichierXsl"/></a><br/>
                        <a href="exos/Exo7/res.xml"><xsl:value-of select="exo/phase3/etape2/resultat"/></a>
                        <br></br>
                        <br></br>
